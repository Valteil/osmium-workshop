...
export type TagCategoryId = 'character' | 'body' | 'face' | 'clothes' | 'limbs' | 'sexual' | 'pose' | 'scene' | 'effects' | 'other';

/** Display order in Single mode and the card modal. */
export const TAG_CATEGORY_ORDER: TagCategoryId[] = ['character', 'body', 'face', 'clothes', 'limbs', 'sexual', 'pose', 'scene', 'effects', 'other'];
